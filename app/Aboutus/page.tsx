...
import { ArrowRight, Award, Globe, Zap, Heart, Coffee, Camera, PenTool } from 'lucide-react';
        ...
        <div ref={heroRef} className="relative z-10 w-full max-w-[90%] mx-auto px-4 md:px-8">
          ...
          <div>
            ...
            {/* <div className="mt-6">
              <a 
                href="#story" 
                className="inline-flex items-center gap-2 px-6 py-2.5 bg-white text-gray-900 rounded-full font-medium hover:bg-gray-100 transition-all duration-300 group text-sm"
              >
                Discover Our Story
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6">
            {[
              ...
              return (
                ...
                >
                  <div className="inline-flex p-3 rounded-full bg-gray-100 mb-3 group-hover:bg-red-50 transition-colors duration-300">
